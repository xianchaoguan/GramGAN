...
def parse_args():
    ...
    parser.add_argument('--dataset',type=str,default='ANHIR',help='dataset_name')
    ...
    parser.add_argument('--result_dir', type=str, default='/result_GramGAN/', help='Directory name to save the results')
